...
import { ChargeSubjects, ExpirationSubjects, nc, OrderSubjects, Streams, TicketSubjects } from '@events/index';
  ...
  stream.forEach(str => {
    switch (str) {
      ...
      case Streams.EXPIRATION:
        ...
        break;
      case Streams.CHARGES:
        apiSubjects.push(Object.values(ChargeSubjects));
        break;
      default:
